...
public class MobileContactsApp {
    ...
    final static Path path = Paths.get("C:\\Users\\Nikos\\OneDrive\\Υπολογιστής\\Notes\\Java\\Exersise in lesson\\log.mobile.txt.txt");
...
//            System.out.printf("%s\t%s\t%s\n", contact[0], contact[1],contact[2]);
    ...
    public static void updateContactService(String oldPhone, String firstname,String lastname, String newPhoneNumber){
        try {
            if(!(update(oldPhone,firstname, lastname ,newPhoneNumber))){
...
//        return contact;
    ...
    public static String[] delete(String phoNumber){
        int positionToDelete = getIndexByPhoneNumber(phoNumber);
        String[] contact = new String[3];
    ...
    /*
      Custom Logger
      ... Λεγονται Varargs String[] message
     */
